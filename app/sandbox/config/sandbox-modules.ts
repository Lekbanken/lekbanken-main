  ...
  },
  {
    ...
    modules: [
      ...
      { 
        ...
        description: 'Layered SVG avatar builder (mobile-first)', 
        status: 'implemented',
        components: [
          ...
          '@/app/sandbox/avatar-builder/components/AvatarPalette',
          '@/app/sandbox/avatar-builder/components/AvatarBuilderShell',
        ],
