  ...
  },
  {
    ...
    modules: [
      ...
      { 
        ...
        description: 'Progression overview med faction-theming (mobil-först)', 
        status: 'implemented',
        components: [
          '@/components/journey/JourneyOverview',
          '@/components/journey/JourneyScene',
          '@/components/journey/JourneyIdentity',
          '@/components/journey/JourneyProgress',
          '@/components/journey/JourneyStats',
          '@/components/journey/JourneyActions',
        ],
