  ...
  },
  {
    ...
    modules: [
      ...
      { 
        ...
        description: 'Progression overview med CSS-animationer, faction-theming, custom factions (ren CSS, inga externa deps)', 
        status: 'done',
        components: [
          '@/app/sandbox/journey/page.tsx',
        ],
        routes: ['/app/resan', '/app/resan/*'],
      },
    ],
  },
  {
  ...
  },
  {
    ...
    modules: [
      ...
      { 
        ...
        href: '/sandbox/play', 
        description: 'Fullständig Play-testmiljö med alla lägen och komponenter', 
        status: 'implemented',
        components: [
          '@/components/play/*',
          '@/features/play/components/*',
          '@/hooks/useSessionCapabilities',
        ],
        routes: ['/sandbox/play', '/sandbox/play/*'],
      },
      { 
        id: 'play-modes', 
        label: 'Play Modes', 
        href: '/sandbox/play/modes', 
        description: 'Jämför Basic, Facilitated och Participants play-lägen', 
        status: 'implemented',
        components: [
          '@/features/play/components/BasicPlayView',
          '@/features/play/components/FacilitatedPlayView',
          '@/features/play/components/ParticipantPlayView',
          '@/hooks/useSessionCapabilities',
        ],
        routes: ['/sandbox/play/modes'],
      },
      { 
        id: 'play-components', 
        label: 'Play Components', 
        href: '/sandbox/play/components', 
        description: 'Alla play-komponenter: Navigation, Content, Controls, Immersion, Panels', 
        status: 'implemented',
        components: [
          '@/features/play/components/StepViewer',
          '@/features/play/components/StepPhaseNavigation',
          '@/features/play/components/TimerControl',
          '@/features/play/components/RoleAssigner',
          '@/features/play/components/TriggerPanel',
          '@/components/play/TypewriterText',
          '@/components/play/Keypad',
        ],
        routes: ['/sandbox/play/components'],
      },
      { 
        id: 'play-participant', 
        label: 'Participant View', 
        href: '/sandbox/play/participant', 
        description: 'Deltagarens perspektiv: mobil/tablet/desktop med scenarion', 
        status: 'implemented',
        components: [
          '@/features/play/components/ParticipantPlayView',
          '@/features/play/components/RoleCard',
          '@/components/play/JoinSessionForm',
        ],
        routes: ['/sandbox/play/participant'],
      },
      { 
        id: 'avatar-builder', 
        label: 'Avatar Builder', 
        href: '/sandbox/avatar-builder', 
        description: 'PNG-baserad avatar-byggare med lager och färgval', 
        status: 'implemented',
        components: [
          '@/app/sandbox/avatar-builder/components/AvatarRenderer',
          '@/app/sandbox/avatar-builder/components/AvatarTabs',
          '@/app/sandbox/avatar-builder/components/AvatarPartGrid',
          '@/app/sandbox/avatar-builder/components/AvatarColorPicker',
          '@/app/sandbox/avatar-builder/components/AvatarDownloadButton',
        ],
        routes: ['/sandbox/avatar-builder'],
      },
    ],
  },
  {
