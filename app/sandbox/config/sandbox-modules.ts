...
export const sandboxCategories: SandboxCategory[] = [
  {
    ...
    modules: [
      ...
      { 
        ...
        label: 'Logo & Wordmark', 
        href: '/sandbox/logo', 
        description: 'Logo layouts and sizing', 
        status: 'done',
        components: ['@/components/layout/Logo', '@/components/marketing/LogoCloud'],
        routes: ['/', '/app', '/admin'],
        tokens: ['logo.size.*', 'logo.spacing'],
      },
      { 
        id: 'colors', 
        label: 'Colors', 
      ...
      { 
        ...
        description: 'Lekbanken-ikon och användningsriktlinjer', 
        status: 'done',
  ...
  },
  {
    ...
    modules: [
      ...
      { 
        id: 'ui-extras', 
        label: 'UI Extras', 
        href: '/sandbox/components/ui-extras', 
        description: 'Toast, sheet, media picker, loading/empty/error', 
        status: 'done',
        components: ['@/components/ui/toast', '@/components/ui/sheet', '@/components/ui/media-picker', '@/components/ui/loading-spinner', '@/components/ui/empty-state', '@/components/ui/error-state', '@/components/ui/breadcrumbs', '@/components/ui/tabs', '@/components/ui/toggle', '@/components/ui/switch'],
        routes: ['*'],
      },
    ],
  },
...
export const moduleGroups = sandboxCategories.map((category) => ({
  ...
  icon: category.icon,
  defaultExpanded: category.id === 'design-system',
