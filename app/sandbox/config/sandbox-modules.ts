...
export const sandboxCategories: SandboxCategory[] = [
  {
    ...
    description: 'GrundlÃ¤ggande designelement och visuellt sprÃ¥k',
    icon: SwatchIcon,
    modules: [
      { 
        id: 'typography', 
      ...
      { 
        ...
        description: 'Lekvalutan, achievements', 
        status: 'done',
        components: ['@/components/AchievementBadge', '@/components/ScoreBoard', '@/features/gamification/*'],
        routes: ['/app/profile', '/app/leaderboard', '/app/achievements'],
      ...
      { 
        ...
        description: 'Badges, lÃ¥s/Ã¶ppna-states och scoreboard-overlay', 
        status: 'done',
  ...
  },
  {
    ...
    label: 'App Sandbox',
    href: '/sandbox/app',
    description: 'Komponenter fÃ¶r spelarappen',
    ...
    modules: [
      ...
      { 
        ...
        description: 'VÃ¤lkomst, stats, senaste aktivitet', 
        status: 'done',
      ...
      { 
        ...
        description: 'Lista + filter + sÃ¶k + grid/list', 
        status: 'done',
      ...
      { 
        ...
        description: 'NivÃ¥, XP, achievements, milestones', 
        status: 'done',
      ...
      { 
        id: 'app-events', 
        label: 'Events / HÃ¤ndelser', 
        href: '/sandbox/app/events', 
        description: 'Event-kort, progress, belÃ¶ningar', 
        status: 'done',
      ...
      { 
        ...
        description: 'MÃ¥l, schema, progress tracking', 
        status: 'done',
      ...
      { 
        ...
        description: 'Artiklar, valutor, kÃ¶p', 
        status: 'done',
  ...
  },
  {
    ...
    label: 'Admin Sandbox',
    href: '/sandbox/admin',
    description: 'Komponenter fÃ¶r adminpanelen',
    icon: CogIcon,
    modules: [
      { 
        id: 'admin-dashboard', 
        ...
        description: 'Ã–versikt, KPI-kort, aktivitetsfeed', 
        status: 'done',
      ...
      { 
        ...
        description: 'AnvÃ¤ndarlista, roller, filter, actions', 
        status: 'done',
      ...
      { 
        ...
        description: 'Rapporter, anvÃ¤ndarhantering', 
        status: 'done',
      ...
      { 
        ...
        description: 'SysteminstÃ¤llningar, konfiguration', 
        status: 'done',
  ...
  },
  {
    ...
    description: 'MarknadsfÃ¶ringskomponenter fÃ¶r landningssidan',
    icon: MegaphoneIcon,
    modules: [
      { 
        id: 'hero', 
  ...
  },
  {
    ...
    description: 'GrundlÃ¤ggande UI-komponenter',
    icon: CubeIcon,
    modules: [
      { 
        id: 'buttons', 
