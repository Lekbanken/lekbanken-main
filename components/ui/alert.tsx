...
const variantStyles: Record<AlertVariant, string> = {
  info: "bg-info/10 border border-info/30 text-info-foreground",
  success: "bg-success/10 border border-success/30 text-success-foreground",
  warning: "bg-warning/10 border border-warning/30 text-warning-foreground",
  error: "bg-destructive/10 border border-destructive/30 text-destructive-foreground",
};
