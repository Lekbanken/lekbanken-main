...
- `test-plans/ADMIN_USERS_TEST_PLAN.md` — manual verification checklist for the `/admin/users` refactor
- `test-plans/ADMIN_PRODUCTS_TEST_PLAN.md` — manual verification checklist for the products/content hub work
- `test-plans/ADMIN_ORGANISATIONS_TEST_PLAN.md` — manual verification checklist for `/admin/organisations`
- `test-plans/ADMIN_GAMIFICATION_TEST_PLAN.md` — manual verification checklist for the gamification hub rollout

### Frozen audits

- `archive/ADMIN_AUDIT.md` — broad admin structure and access audit snapshot
- `archive/ADMIN_AUTH_AUDIT.md` — auth and RBAC integrity audit snapshot
- `archive/ADMIN_OVERVIEW_REPORT.md` — earlier production-readiness overview for the admin area
...
- `archive/ADMIN_AUDIT.md`
- `archive/ADMIN_AUTH_AUDIT.md`
- `archive/ADMIN_OVERVIEW_REPORT.md`
- `ADMIN_MODEL_DECISION.md`
- `ADMIN_NAVIGATION_MASTER.md`
- `ADMIN_IA_PROPOSAL.md`
- `ADMIN_DESIGN_SYSTEM.md`
...
- `test-plans/ADMIN_GAMIFICATION_TEST_PLAN.md`
