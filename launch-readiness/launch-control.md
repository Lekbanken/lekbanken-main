...
| Demo | ✅ | ✅ | ❌ | ❌ | ❌ | ❌ | Audit complete — 18 findings (0 P0, 3 P1, 10 P2, 5 P3). Own domain per GPT directive (Tier 1 — externt exponerad). **M1 ✅** — 3 P1 fixed: DEMO-001 (DB-backed rate limiter), DEMO-002 (hardcoded access code removed), DEMO-003 (error leak removed). 0 P1 remaining. Regression pending. See `audits/demo-audit.md`. |
