-- =============================================================================
-- Migration: 20260125154501_recreate_keypad_v2_function.sql
-- Description: Recreate keypad V2 function now that session_artifact_state table exists
-- =============================================================================
-- The original migration 20260125000003 failed to create this function because
-- the session_artifact_state table didn't exist (it was a VIEW blocking table creation).
-- Now that we've fixed the table, we can create the function.
-- =============================================================================

-- Drop and recreate the function to ensure it's properly created
DROP FUNCTION IF EXISTS public.attempt_keypad_unlock_v2(UUID, UUID, TEXT, UUID, TEXT);
