-- =============================================================================
-- Migration: 20260202100001_fix_atomic_upsert_auth_check.sql
-- Purpose: Fix auth check to work with service_role via Supabase JS client
--
-- BUG: current_user check doesn't work reliably with PostgREST/service_role
-- FIX: Use current_setting('request.jwt.claims', true) to check role claim
-- =============================================================================
...
comment on function public.upsert_game_content_v1(jsonb)
  is 'Atomic upsert for game content - v1.2 fixed auth check for service_role JWT';
