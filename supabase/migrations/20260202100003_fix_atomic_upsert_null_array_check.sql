-- =============================================================================
-- Migration: 20260202100003_fix_atomic_upsert_null_array_check.sql
-- Purpose: Fix jsonb_array_length check for null/scalar values
--
-- BUG: jsonb_array_length fails on null or scalar values
-- FIX: Add jsonb_typeof check before calling jsonb_array_length
-- =============================================================================
...
comment on function public.upsert_game_content_v1(jsonb)
  is 'Atomic upsert for game content - v1.4 fixed safe array type check';
