-- Admin Gamification Analytics v2
-- Adds campaign bonus reporting (per campaign) without breaking v1.

begin;

create or replace function public.admin_get_gamification_analytics_v2(
  p_tenant_id uuid,
...
revoke all on function public.admin_get_gamification_analytics_v2(uuid, integer) from public;
grant execute on function public.admin_get_gamification_analytics_v2(uuid, integer) to service_role;
