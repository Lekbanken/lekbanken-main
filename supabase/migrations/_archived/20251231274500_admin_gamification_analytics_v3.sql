-- Admin Gamification Analytics v3
-- Adds automation rule reward reporting without breaking v2.

begin;

create or replace function public.admin_get_gamification_analytics_v3(
  p_tenant_id uuid,
...
revoke all on function public.admin_get_gamification_analytics_v3(uuid, integer) from public;
grant execute on function public.admin_get_gamification_analytics_v3(uuid, integer) to service_role;
