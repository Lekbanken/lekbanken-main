...
-- =============================================================================
-- 1. Drop the conflicting view IF it still exists as a view
-- =============================================================================
-- Fresh-install fix: 20260125000001 may have already dropped the view and
-- created the table. Only drop if it's still a view.
DO $$ BEGIN
  IF EXISTS (
