  ...
  public: {
    Tables: {
      ...
      categories: {
        ...
        Relationships: [
          {
            foreignKeyName: "categories_bundle_product_id_fkey"
            columns: ["bundle_product_id"]
            isOneToOne: false
            referencedRelation: "products"
            referencedColumns: ["id"]
      ...
      cosmetic_unlock_rules: {
        ...
        Relationships: [
          {
            foreignKeyName: "cosmetic_unlock_rules_cosmetic_id_fkey"
            columns: ["cosmetic_id"]
            isOneToOne: false
      ...
      run_sessions: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "run_sessions_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "participant_sessions"
            referencedColumns: ["id"]
      ...
      session_trigger_idempotency: {
        ...
        Relationships: [
          {
            foreignKeyName: "session_trigger_idempotency_game_trigger_id_fkey"
          ...
          {
            foreignKeyName: "session_trigger_idempotency_session_id_fkey"
            columns: ["session_id"]
            isOneToOne: false
            referencedRelation: "participant_sessions"
            referencedColumns: ["id"]
      ...
      shop_items: {
        ...
        Relationships: [
          {
            foreignKeyName: "shop_items_cosmetic_id_fkey"
            columns: ["cosmetic_id"]
            isOneToOne: false
            referencedRelation: "cosmetics"
            referencedColumns: ["id"]
      ...
      spatial_artifacts: {
        ...
        Relationships: [
          {
            foreignKeyName: "spatial_artifacts_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: false
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      system_audit_logs: {
        Row: {
          actor_user_id: string | null
          created_at: string
          event_type: Database["public"]["Enums"]["system_audit_event_type"]
          id: string
          metadata: Json | null
          tenant_id: string | null
        }
      ...
      system_jobs_runs: {
        Row: {
          ...
          started_at: string
          status: Database["public"]["Enums"]["system_job_run_status"]
        }
        Insert: {
          elapsed_ms?: number | null
          errors?: Json | null
      ...
      tenant_restore_vault: {
        ...
        Relationships: [
          {
            foreignKeyName: "tenant_restore_vault_created_by_fkey"
            columns: ["created_by"]
            isOneToOne: false
            referencedRelation: "users"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "tenant_restore_vault_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: true
            referencedRelation: "tenants"
            referencedColumns: ["id"]
      ...
      tenants: {
        Row: {
          ...
          anonymization_version: number | null
        ...
        Relationships: [
          {
            foreignKeyName: "tenants_anonymized_by_fkey"
      ...
      user_cosmetic_loadout: {
        ...
        Relationships: [
          {
            foreignKeyName: "user_cosmetic_loadout_cosmetic_id_fkey"
            columns: ["cosmetic_id"]
            isOneToOne: false
            referencedRelation: "cosmetics"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      calculate_next_retry: {
        Args: { p_base_delay_seconds?: number; p_retry_count: number }
        Returns: string
      }
      ...
      get_liked_game_ids: { Args: never; Returns: string[] }
    ...
    Enums: {
      ...
      system_audit_event_type:
        ...
        | "TENANT_PURGED"
        | "TENANT_PURGED_AUTO"
      system_job_run_status: "running" | "ok" | "warn" | "fail"
      tenant_role_enum:
        | "owner"
        | "admin"
        | "editor"
